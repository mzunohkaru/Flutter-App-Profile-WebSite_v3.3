...
class DesktopPolicyPage extends StatefulWidget {
  const DesktopPolicyPage({super.key});

  @override
  State<DesktopPolicyPage> createState() => _DesktopPolicyPageState();
}

class _DesktopPolicyPageState extends State<DesktopPolicyPage> {
  bool isJP = true;
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          const SubtitleText(subtitle: "Privacy Policy"),
          const SizedBox(
            height: 30,
          ),
          //見出し
          ...
          buildHead(
              ...
              head:
                  isJP ? "個人情報の取得について" : "Acquisition of Personal Information"),
          //本文
          buildText(isJP
          ...
          buildHead(
              ...
              head: isJP ? "個人情報の利用について" : "Use of Personal Information"),
          //本文
          buildText(
            isJP
          ...
          buildHead(
              ...
              head:
                  isJP ? "個人情報の委託について" : "Outsourcing of Personal Information"),
          //本文
          buildText(
            isJP
          ...
          buildHead(
              ...
              head: isJP ? "方針の変更" : "Policy Changes"),
          //本文
          buildText(
            isJP
